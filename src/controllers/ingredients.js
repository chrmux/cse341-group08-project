...
const postIngredients = async (req, res) => {
  ...
  try {
    ...
    res
      .status(400)
      .json(
        "Ingredients Post Request: Invalid request data found in request body."
      );
  }
};
  ...
  try {
    ...
    if (result == null) {
      res
        .status(404)
        .json({
          error: `Ingredients Put Request: No item found with id of ${id}`,
        });
      return;
    }
    ...
    res
      .status(400)
      .json(
        "Ingredients Put Request: Invalid request data found in request body."
      );
  }
};
